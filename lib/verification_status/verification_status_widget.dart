...
class _VerificationStatusWidgetState extends State<VerificationStatusWidget> {
  late VerificationStatusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerificationStatusModel());
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Awaiting admin review, it may take 1-2 hours in order for your verification to go through and show up on your account please be patient.',
                textAlign: TextAlign.center,
