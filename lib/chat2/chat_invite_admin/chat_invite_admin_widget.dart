...
import 'chat_invite_admin_model.dart';
export 'chat_invite_admin_model.dart';

class ChatInviteAdminWidget extends StatefulWidget {
  const ChatInviteAdminWidget({
    super.key,
    this.chatRef,
    this.user,
  });
  ...
  @override
  State<ChatInviteAdminWidget> createState() => _ChatInviteAdminWidgetState();
}

class _ChatInviteAdminWidgetState extends State<ChatInviteAdminWidget> {
  late ChatInviteAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatInviteAdminModel());
                    ...
                    onPressed: () async {
                      if (_model.friendsList.isNotEmpty) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'You must select at least one admin to start a chat.',
                              style: FlutterFlowTheme.of(context)
                                  .titleSmall
                                  .override(
                                    fontFamily: 'Readex Pro',
