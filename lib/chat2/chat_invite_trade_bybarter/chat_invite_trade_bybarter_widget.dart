...
import '/chat2/empty_state_simple/empty_state_simple_widget.dart';
...
import 'chat_invite_trade_bybarter_model.dart';
export 'chat_invite_trade_bybarter_model.dart';

class ChatInviteTradeBybarterWidget extends StatefulWidget {
  const ChatInviteTradeBybarterWidget({
    super.key,
    this.chatRef,
    this.user,
  });
  ...
  @override
  State<ChatInviteTradeBybarterWidget> createState() =>
      _ChatInviteTradeBybarterWidgetState();
}

class _ChatInviteTradeBybarterWidgetState
    extends State<ChatInviteTradeBybarterWidget> {
  late ChatInviteTradeBybarterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatInviteTradeBybarterModel());
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      if (_model.friendsList.isNotEmpty) {
                        if (widget.chatRef != null) {
                          // updateChat
