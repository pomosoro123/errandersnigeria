...
import 'customersupport_model.dart';
export 'customersupport_model.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AdminRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AdminRecord> customersupportAdminRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final customersupportAdminRecord =
            customersupportAdminRecordList.isNotEmpty
                ? customersupportAdminRecordList.first
                : null;
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  await launchUrl(Uri(
                                    scheme: 'tel',
                                    path:
                                        customersupportAdminRecord!.phonenumber,
                                  ));
                                },
                                child: Container(
                                  width: 120.0,
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  await launchUrl(Uri(
                                      scheme: 'mailto',
                                      path: customersupportAdminRecord!.email,
                                      query: {
                                        'subject':
                                            'Erranders Nigeria Customer Support',
                                      }
                                          .entries
                              ...
                              builder: (alertDialogContext) {
                                return WebViewAware(
                                  child: AlertDialog(
                                    ...
                                    content: const Text(
                                        'Your Ticket has been successfully submitted. Our admin representatives will get back to you shortly.'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
