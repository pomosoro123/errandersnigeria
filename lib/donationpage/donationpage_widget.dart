...
import 'donationpage_model.dart';
export 'donationpage_model.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AdminRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final donationpageAdminRecord = snapshot.data!;
                          ...
                          children: [
                              ...
                              builder: (context, snapshot) {
                                ...
                                return TextFormField(
                                  controller: _model.textController3 ??=
                                      TextEditingController(
                                    text: valueOrDefault<String>(
                                      textFieldAdminRecord?.phonenumber,
                                      'Null',
                                    ),
                                  ),
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText:
                                    'Short description of the amount you want to donate',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                          ...
                          onPressed: () async {
                            await DonationRecord.collection.doc().set({
                              ...createDonationRecordData(
                                ...
                                image:
                                    'https://th.bing.com/th/id/OIP.6bsDYdeZg4xijSLULtv61AAAAA?rs=1&pid=ImgDetMain',
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  await launchUrl(Uri(
                                    scheme: 'tel',
                                    path: donationpageAdminRecord.phonenumber,
                                  ));
                                },
                                child: Container(
                                  width: 120.0,
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  await launchUrl(Uri(
                                      scheme: 'mailto',
                                      path: donationpageAdminRecord.email,
                                      query: {
                                        'subject':
