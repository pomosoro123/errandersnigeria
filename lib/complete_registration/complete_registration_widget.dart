...
class _CompleteRegistrationWidgetState
  ...
  void initState() {
    ...
    _model.ninNoTextController ??= TextEditingController();
    _model.ninNoFocusNode ??= FocusNode();
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
                child: TextFormField(
                  controller: _model.ninNoTextController,
                  focusNode: _model.ninNoFocusNode,
                  textCapitalization: TextCapitalization.words,
                  obscureText: false,
                  decoration: InputDecoration(
                  ...
                  validator:
                      _model.ninNoTextControllerValidator.asValidator(context),
                ),
              ),
              Padding(
                ...
                child: FlutterFlowDropDown<String>(
                  ...
                  hintText: 'Select Verification Document',
                  icon: Icon(
                    Icons.keyboard_arrow_down_rounded,
                    color: FlutterFlowTheme.of(context).secondaryText,
                    size: 15.0,
                      ...
                      if (_model.yourNameTextController.text == '') {
                        ...
                        if (_model.uploadedFileUrl == '') {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Please Select a Document and allow it to load ',
                                style: TextStyle(
                                  color:
                          ...
                          await currentUserReference!.update({
                            ...createUsersRecordData(
                              ...
                              address: _model.cityTextController2.text,
                              state: _model.stateValue,
                              documentimage: _model.uploadedFileUrl,
                              nin: _model.ninNoTextController.text,
                              underReview: true,
                              phoneNumber: '',
                              blocked: false,
                              type: '',
                          ...
                          await NotificationsRecord.collection.doc().set({
                            ...createNotificationsRecordData(
                              ...
                              body:
                                  'Welcome User, your account is being reviewed and awaiting admin approval',
                              sent: true,
                              read: false,
                              sender: currentUserReference,
                              type: 'bot',
                              image:
                                  'data:image/jpeg;base64,',
                          ...
                          await VerificationRecord.collection.doc().set({
                            ...createVerificationRecordData(
                              token: valueOrDefault<String>(
                                _model.ninNoTextController.text,
                                'Null',
                              ),
                              ref: currentUserReference,
                              image: _model.uploadedFileUrl,
                              document: valueOrDefault<String>(
                                _model.documenttypeValue,
                                'Null',
                              ),
                              approved: false,
                              seen: false,
                              documentid: _model.ninNoTextController.text,
                              closed: false,
