                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(
                                'chatU',
                                queryParameters: {
                                  'refhead': serializeParam(
                                    columnChatRecord.reference,
                                    ParamType.DocumentReference,
                                  ),
                                  'reciever': serializeParam(
                                    columnChatRecord.receiver?.id,
                                    ParamType.String,
                                  ),
                                  'usersinvolved': serializeParam(
                                    columnChatRecord.outputusers,
                                    ParamType.DocumentReference,
                                    true,
                                  ),
                                }.withoutNulls,
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                              columnChatRecord.recieverimage,
                                              width: 44.0,
                                              height: 44.0,
                                              fit: BoxFit.cover,
                                            ),
