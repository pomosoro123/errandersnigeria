...
import 'trade_postan_item_model.dart';
export 'trade_postan_item_model.dart';

class TradePostanItemWidget extends StatefulWidget {
  const TradePostanItemWidget({super.key});

  @override
  State<TradePostanItemWidget> createState() => _TradePostanItemWidgetState();
}

class _TradePostanItemWidgetState extends State<TradePostanItemWidget> {
  late TradePostanItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TradePostanItemModel());
                  ...
                  children: [
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Fill all the Details Accordingly',
                          style:
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<List<TBBMainCategoriesRecord>>(
                        stream: queryTBBMainCategoriesRecord(),
                        builder: (context, snapshot) {
                          ...
                          List<TBBMainCategoriesRecord>
                              categoryTBBMainCategoriesRecordList =
                              snapshot.data!;
                          return FlutterFlowDropDown<String>(
                            controller: _model.categoryValueController ??=
                                FormFieldController<String>(null),
                            options: categoryTBBMainCategoriesRecordList
                                .map((e) => e.category)
                                .toList(),
                            onChanged: (val) =>
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 10.0),
                      child: StreamBuilder<List<TradecategoriesRecord>>(
                        stream: queryTradecategoriesRecord(
                          queryBuilder: (tradecategoriesRecord) =>
                              tradecategoriesRecord.where(
                            'category',
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<TradecategoriesRecord>
                              subcategoryTradecategoriesRecordList =
                              snapshot.data!;
                          return FlutterFlowDropDown<String>(
                            controller: _model.subcategoryValueController ??=
                                FormFieldController<String>(null),
                            options: subcategoryTradecategoriesRecordList
                                .map((e) => e.title)
                                .toList(),
                            onChanged: (val) =>
                    ...
                    if (_model.subcategoryValue == 'others')
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            20.0, 0.0, 20.0, 10.0),
                        child: SizedBox(
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        await TradeitemsRecord.collection.doc().set({
                          ...createTradeitemsRecordData(
                            img: _model.uploadedFileUrl,
                            title:
                                'Trading ${_model.subcategoryValue} for ${_model.textController2.text}',
                            price: 000,
                            owner: currentUserEmail,
                            status: 'active',
                            category: _model.categoryValue,
                            subcategory: _model.subcategoryValue,
                            item: _model.textController2.text,
                          ...
                          builder: (alertDialogContext) {
                            return WebViewAware(
                              child: AlertDialog(
                                ...
                                content: const Text('Advert Posted'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
