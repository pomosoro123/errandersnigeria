...
import 'paymentviatransfer_model.dart';
export 'paymentviatransfer_model.dart';

class PaymentviatransferWidget extends StatefulWidget {
  const PaymentviatransferWidget({
    super.key,
  ...
  @override
  State<PaymentviatransferWidget> createState() =>
      _PaymentviatransferWidgetState();
}

class _PaymentviatransferWidgetState extends State<PaymentviatransferWidget>
    with TickerProviderStateMixin {
  late PaymentviatransferModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentviatransferModel());
                  ...
                  onPressed: () async {
                    ...
                    await depositsRecordReference.set({
                      ...createDepositsRecordData(
                        ...
                        amount: FFAppState().value.toDouble(),
                        description:
                            'Errand \"${FFAppState().string}\" payment',
                        status: 'pending',
                        bankname: 'admin',
                        bankaccount: 'admin',
                        approved: false,
                    ...
                    await NotificationsRecord.collection.doc().set({
                      ...createNotificationsRecordData(
                        ...
                        body: 'Your deposit request  of  ${formatNumber(
                          FFAppState().value2,
                          formatType: FormatType.decimal,
                          decimalType: DecimalType.automatic,
                          currency: ' ₦',
                        )} has been submitted and awaiting admin  approval',
                        sent: true,
                        read: false,
                      ...
                      builder: (alertDialogContext) {
                        return WebViewAware(
                          child: AlertDialog(
                            ...
                            content: const Text('Errand Payment request submitted '),
                            actions: [
                              TextButton(
                                onPressed: () =>
